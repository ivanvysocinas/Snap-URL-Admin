/**
 * Authentication login form with comprehensive validation and error handling
 * Features real-time field validation, password visibility toggle, and smooth animations
 * Integrates with AuthContext for login operations and error management
 * Provides accessibility features and responsive design
 */
"use client";
...
const LoginForm = () => {
  ...
  /**
   * Validate form fields with email regex and password length checks
   * Returns boolean indicating overall form validity
   */
   ...
   * Clears field-specific errors and auth errors when user types
   */
  ...
  /**
   * Handle form submission with validation and auth integration
   */
